...
@From    : MeteGPT
"""
from xagents.actions import WritePRD, WriteTasks, WriteDesign
from xagents.roles import Role


class ProductManager(Role):
    def __init__(self, watch_actions, name="Alice", profile="Product Manager",
...
class Architect(Role):
    ...
    def __init__(self, watch_actions, name="Bob", profile="Architect",
